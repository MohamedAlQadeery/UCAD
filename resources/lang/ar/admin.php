...
return [
    ...
    'createEnPAge' => 'إضافة صفحة إنجليزية',
    'showApplications' => 'عرض طلبات إنضمام لدورات',
    'showAllPages' => 'إظهار الصفحات',
    'createArPAge' => 'إضافة صفحة عربية',
    'englishPages' => 'الصفحات الإنجليزية',
    'arabicPages' => 'الصفحات العربية',
    'menusIndex' => 'إظهار القوائم',
    'createMenu' => 'إضافة قائمة',
    'password_confirmation' => 'تاكيد كلمة السر',
    'english name' => 'الإسم بالانجليزي',
    'options' => 'خيارات',
    'arabic name' => 'الإسم بالعربي',
    'albam' => 'ألبوم',
    'showItems' => 'إظهار القوائم الفرعية',
    'addItem' => 'إضافة قائمة فرعية',
    'slider' => 'صور متحركة',
    'showSliders' => 'إظهار الصور المتحركة',
    'createSilder' => 'إضافة الصور المتحركة',
    'group' => 'المجموعات',
    "showGroups"=>"إظهار المجموعات",
    "createGroup"=>"إضافة مجموعة",
    "adminAndGroupRole"=>"المجموعات و المشرفين",
    "menusRole"=>"القوائم",
    "messagesRole"=>"",
    "galleryRole"=>"معرض الصور",
    "sliderRole"=>"صور متحركة",
    "showRole"=>"إظهار",
    "createRole"=>"إنشاء",
    "editRole"=>"تعديل",
    "deleteRole"=>"الحذف",
